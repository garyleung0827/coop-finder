...
class abstractDAO {
    ...
    protected static $DB_PORT = 3307;// my database port is 3307
    /* Database username */
    protected static $DB_USERNAME = "appuser"; // choose a username
    /* Database password */
    protected static $DB_PASSWORD = "password"; //choose a password
    /* Name of database */
    protected static $DB_DATABASE = "coop"; //choose a database
